...
# Asset create non-multipart
check_code "asset create non-multipart" "$BASE/api/admin/assets" "400" -b /tmp/smoke-admin.jar -X POST -H "Content-Type: application/json" -d "{}"
