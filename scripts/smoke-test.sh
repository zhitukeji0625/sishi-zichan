...
# 12. Upload without multipart should return 400
UPLOAD_CODE=$(curl -s -b /tmp/smoke_admin.txt -o /dev/null -w '%{http_code}' -X POST "$BASE/api/upload" -H 'Content-Type: application/json' -d '{}')
