...
check_code "admin assets page" "$BASE/admin/assets" "200" -b /tmp/smoke-admin.jar
check_code "admin auctions page" "$BASE/admin/auctions" "200" -b /tmp/smoke-admin.jar
...
check_code "admin assets non-multipart" "$BASE/api/admin/assets" "400" -b /tmp/smoke-admin.jar -X POST -H "Content-Type: application/json" -d "{}"
