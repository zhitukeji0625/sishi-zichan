...
# 8. Upload invalid body
check "upload invalid body" "400" "$(curl -s -o /dev/null -w '%{http_code}' -b /tmp/smoke_admin.txt -X POST "$BASE/api/upload" -H 'Content-Type: application/json' -d '{}')"
