...
export const builtInDictCategories = [
  {
    code: "asset_type",
    name: "资产类型",
...
/** Idempotent seed for built-in data dictionary categories. */
export async function seedBuiltInDicts(client: PrismaClient) {
  for (const cat of builtInDictCategories) {
