...
/** Keep demo auction LIVE so README demo account can bid after long-running deployments. */
async function refreshDemoAuction() {
  ...
  if (project) {
    ...
    console.log("Demo auction refreshed:", project.id);
    return;
  }
  ...
  console.log("Demo auction created:", newProject.id);
}
