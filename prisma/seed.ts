...
/** Keep demo auction LIVE for automated / cron testing when DB already has seed data. */
async function refreshDemoAuction() {
  ...
  console.log(`Demo auction refreshed: ${project.asset.name} (LIVE until ${endsAt.toISOString()})`);
}
