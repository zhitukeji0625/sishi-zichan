...
/** Keep demo auction LIVE so README demo account can bid after cron/seed reruns. */
...
async function main() {
  ...
  if (existing > 0) {
    ...
    console.log("Seed skipped: data already present (dict ensured, demo auction refreshed).");
    return;
  }
