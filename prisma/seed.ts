...
const DEMO_AUCTION_CODE = "AP_DEMO";
...
async function refreshDemoAuction() {
  ...
  console.log("Demo auction refreshed (AP_DEMO, LIVE, +7 days).");
}
...
async function main() {
  ...
  if (existing > 0) {
    ...
    console.log("Seed skipped: core data already present (demo auction refreshed).");
    return;
  }
