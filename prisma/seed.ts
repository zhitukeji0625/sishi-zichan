...
/** Ensure at least one LIVE auction exists for demo/testing when seed data is present. */
async function ensureDemoLiveAuction() {
  ...
  if (!asset) {
    console.log("ensureDemoLiveAuction: no asset found, skipped.");
    return;
  }
  ...
  console.log(`ensureDemoLiveAuction: created ${project.code}`);
}
