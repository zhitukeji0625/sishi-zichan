...
async function refreshDemoAuctionIfExpired() {
  ...
  console.log(`Refreshed expired demo auction ${project.code} → LIVE until ${ends.toISOString()}`);
}
