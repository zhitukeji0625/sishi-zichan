...
/** Keep demo auction usable when seed runs against an existing database. */
async function ensureDemoAuction() {
  ...
  if (project) {
    ...
    console.log(`Demo auction refreshed: ${project.code} (${project.asset.name})`);
  } else {
    ...
    console.log(`Demo auction created: ${project.code} (${project.asset.name})`);
  }
