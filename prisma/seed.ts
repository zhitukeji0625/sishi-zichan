...
/** Refresh the demo auction window when seed data already exists but the project has ended. */
async function refreshDemoAuction() {
  ...
  console.log(`Refreshed demo auction ${ended.code} → LIVE until ${ends.toISOString()}`);
}
