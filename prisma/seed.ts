...
/** Keep demo auction LIVE when seed data already exists but the project has ended. */
async function renewDemoAuctionIfNeeded() {
  ...
  console.log(`Renewed demo auction ${reg.project.code} → LIVE until ${ends.toISOString()}`);
}
