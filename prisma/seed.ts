...
/** Keep the latest demo auction LIVE for functional testing when re-seeding. */
...
async function main() {
  ...
  if (existing > 0) {
    ...
    console.log("Seed skipped: data already present. Refreshed demo auction & dict.");
    return;
  }
