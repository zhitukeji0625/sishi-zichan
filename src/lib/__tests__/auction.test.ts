...
import { placeBid, getMinNextBidAmount } from "@/lib/auction";
...
const prismaDescribe = process.env.DATABASE_URL ? describe : describe.skip;

prismaDescribe("placeBid（需 DATABASE_URL）", () => {
