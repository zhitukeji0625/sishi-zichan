...
export async function placeBid(params: {
  ...
  return prisma.$transaction(async (tx) => {
    ...
    const minNext = minNextBidAmount(project, top ? new Decimal(top.amount.toString()) : null);
