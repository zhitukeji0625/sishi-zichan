...
export function computeMinimumNextBidAmount(params: {
  ...
  if (params.highestBidAmount == null || params.highestBidAmount === undefined) {
    return start;
  }
...
export async function placeBid(params: {
  ...
  return prisma.$transaction(async (tx) => {
    ...
    const minNext = computeMinimumNextBidAmount({
