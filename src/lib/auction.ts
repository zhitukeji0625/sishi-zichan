...
export type AuctionTxClient = Prisma.TransactionClient;
...
export async function placeBidInTransaction(
  tx: AuctionTxClient,
...
export async function placeBid(params: {
  ...
  return prisma.$transaction((tx) => placeBidInTransaction(tx, params));
}
