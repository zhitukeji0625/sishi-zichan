...
export default async function AuctionDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  let assetImageUrls: string[] | null = null;
  try {
    const parsed = project.asset.imagesJson ? JSON.parse(project.asset.imagesJson) : [];
    assetImageUrls =
      Array.isArray(parsed) && parsed.every((u: unknown) => typeof u === "string")
        ? (parsed as string[])
        : null;
  } catch {
    assetImageUrls = null;
