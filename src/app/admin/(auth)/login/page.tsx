    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label htmlFor="admin-login-phone" className="mb-1 block text-sm font-medium text-slate-700">手机号</label>
            <input
          ...
          <div>
            <label htmlFor="admin-login-password" className="mb-1 block text-sm font-medium text-slate-700">密码</label>
            <input
