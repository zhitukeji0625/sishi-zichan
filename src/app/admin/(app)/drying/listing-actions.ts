...
const DRYING_LISTING_STATUSES: DryingListingStatus[] = [
  "OPERATING",
  "MAINTENANCE",
  "PAUSED",
  "OFFLINE",
...
function parseDryingListingStatus(value: string): DryingListingStatus | null {
  return DRYING_LISTING_STATUSES.includes(value as DryingListingStatus)
