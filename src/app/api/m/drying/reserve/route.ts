...
import { parseLocalDate, validateBookingAdvance, validateReservationRange } from "@/lib/drying";
...
export async function POST(req: Request) {
  ...
  const advanceCheck = await validateBookingAdvance(parsed.data.listingId, start);
  if (!advanceCheck.ok) {
