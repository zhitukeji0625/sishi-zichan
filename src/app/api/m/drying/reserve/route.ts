...
import { validateReservationRange, userHasOverlappingReservation } from "@/lib/drying";
...
export async function POST(req: Request) {
  ...
  if (await userHasOverlappingReservation(parsed.data.listingId, user.id, start, end)) {
