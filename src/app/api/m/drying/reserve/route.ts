...
import { userHasOverlappingReservation, validateReservationRange } from "@/lib/drying";
...
export async function POST(req: Request) {
  ...
  if (await userHasOverlappingReservation(user.id, parsed.data.listingId, start, end)) {
