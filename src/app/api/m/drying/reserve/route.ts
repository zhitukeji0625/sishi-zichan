...
import { validateAdvanceBookingWindow, validateReservationRange } from "@/lib/drying";
...
export async function POST(req: Request) {
  ...
  const advanceCheck = await validateAdvanceBookingWindow(parsed.data.listingId, start);
  if (!advanceCheck.ok) {
