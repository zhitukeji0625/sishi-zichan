...
export async function POST(req: Request) {
  ...
  const formDataOrErr = await parseFormData(req);
  if (formDataOrErr instanceof Response) {
    return NextResponse.json(await formDataOrErr.json(), { status: formDataOrErr.status });
  }
